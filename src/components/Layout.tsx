          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 mb-12">
            ...
            <div className="lg:col-span-4">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://wa.me/905521065579" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
                ...
                <a href="tel:+905521065579" aria-label="Telefon"
            ...
            <div className="lg:col-span-3">
              ...
              <ul className="flex flex-col gap-4 mt-4">
                <li>
                  <a href="tel:+905521065579" className="flex items-start gap-3 text-slate-300 hover:text-white transition-colors group">
                    ...
                    <div>
                      ...
                      <span className="font-black text-sm">0552 106 55 79</span>
                    </div>
                  </a>
                </li>
                <li>
